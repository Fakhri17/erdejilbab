      ...
      <div class="flex flex-row flex-wrap items-center gap-2">
        ...
        <div class="hs-dropdown relative inline-flex">
          <button id="hs-dropdown-example" type="button"
            ...
            Kategori
            <svg class="hs-dropdown-open:rotate-180 size-4 text-gray-600" xmlns="http://www.w3.org/2000/svg" fill="none"
...
@php
$products = [
['name' => 'Hijab Basic', 'description' => 'Nyaman dan lembut dipakai harian.', 'image_url' =>
'/img/image.png', 'harga' => 100000],
['name' => 'Hijab Premium', 'description' => 'Tampil elegan dengan bahan premium.', 'image_url' =>
'/img/image-14.png', 'harga' => 200000],
['name' => 'Hijab Instan', 'description' => 'Praktis tanpa jarum, langsung pakai.', 'image_url' =>
'/img/image-15.png', 'harga' => 150000],
['name' => 'Hijab Syar\'i', 'description' => 'Menutup sempurna dengan gaya.', 'image_url' =>
'/img/image.png', 'harga' => 120000],
['name' => 'Hijab Segi Empat', 'description' => 'Klasik dan timeless.', 'image_url' =>
'/img/image-14.png', 'harga' => 90000],
['name' => 'Hijab Pashmina', 'description' => 'Bisa dipakai berbagai gaya.', 'image_url' =>
'/img/image-15.png', 'harga' => 130000],
['name' => 'Hijab Satin', 'description' => 'Bahan satin yang mewah.', 'image_url' =>
'/img/image.png', 'harga' => 250000],
];
@endphp
...
<section>
  <div class="container mx-auto px-4 py-8">
    ...
    <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold">
      ...
      <span class="opacity-50 font-normal text-2xl sm:text-3xl md:text-4xl">({{ count($products) }})</span>
    </h1>

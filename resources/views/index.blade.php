...
@section('content')
  ...
  <section class="py-10 bg-white">
    <div class="max-w-6xl mx-auto px-4 flex flex-col-reverse md:flex-row justify-between items-center gap-8">
      <div class="md:w-1/2 text-center md:text-left">
        ...
        <a href="#"
          class="inline-block px-6 py-3 font-bold text-[#946756] rounded border border-gray-300 shadow hover:bg-[#E48786] hover:text-black transition duration-200">
          Lihat Produk
        </a>
      </div>
  ...
  <section class="max-w-6xl mx-auto px-4 py-10 text-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="bg-white rounded-xl shadow-md p-6">
        <div class="flex flex-col md:flex-row items-center md:items-start gap-4 mb-3 text-center md:text-left">
          <div class="flex flex-col md:flex-row items-center md:items-center gap-4">
            <img src="/assets/icon1.png" alt="Bahan Berkualitas">
      ...
      <div class="bg-white rounded-xl shadow-md p-6">
        <div class="flex flex-col md:flex-row items-center md:items-start gap-4 mb-3 text-center md:text-left">
          <div class="flex flex-col md:flex-row items-center md:items-center gap-4">
            <img src="/assets/icon2.png" alt="Desain Eksklusif">
      ...
      <div class="bg-white rounded-xl shadow-md p-6">
        <div class="flex flex-col md:flex-row items-center md:items-start gap-4 mb-3 text-center md:text-left">
          <div class="flex flex-col md:flex-row items-center md:items-center gap-4">
            <img src="/assets/icon3.png" alt="Harga Terjangkau">
  ...
  <section class="max-w-6xl mx-auto px-4 py-10">
    <div class="flex items-center justify-between mb-6">
      <h2 class="text-2xl font-bold">Produk <span class="text-[#E48786]">Unggulan</span></h2>
      <a href="#" class="font-bold text-[#946756] hover:text-[#E48786]">Lihat Semua &gt;</a>
    </div>
    <p class="text-sm text-gray-500 mb-8">Pilihan Terbaik untuk Tampil Cantik dan Syar'i Setiap Hari</p>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
      ...
      <div class="bg-white border border-gray-300 rounded-xl shadow-sm p-4">
        ...
        <p class="text-sm text-gray-500 mb-4">Bahan katun ombre super dengan ukuran 180x80cm</p>
        <button
          class="text-sm text-[#946756] hover:text-black hover:bg-[#E48786] border border-gray-300 px-4 py-2 rounded shadow transition duration-200">Lihat
          Produk</button>
      </div>
      ...
      <div class="bg-white border border-gray-300 rounded-xl shadow-sm p-4">
        ...
        <p class="text-sm text-gray-500 mb-4">Bahan rayon spandex super dengan ukuran 180x60cm</p>
        <button
          class="text-sm text-[#946756] hover:text-black hover:bg-[#E48786] border border-gray-300 px-4 py-2 rounded shadow transition duration-200">Lihat
          Produk</button>
      </div>
      ...
      <div class="bg-white border border-gray-300 rounded-xl shadow-sm p-4">
        ...
        <p class="text-sm text-gray-500 mb-4">Bahan voal miracle ori Azara dengan ukuran 110x110cm</p>
        <button
          class="text-sm text-[#946756] hover:text-black hover:bg-[#E48786] border border-gray-300 px-4 py-2 rounded shadow transition duration-200">Lihat
          Produk</button>
      </div>
  ...
  <section class="max-w-6xl mx-auto px-4 py-10 text-center">
    <h2 class="text-2xl font-bold">Hubungi <span class="text-[#E48786]">Kami</span></h2>
    <p class="text-sm text-gray-600 mt-2 mb-8">Ada pertanyaan, saran, atau ingin memesan langsung?</p>

    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
      <!-- Shopee -->
      <div
        class="border border-gray-300 hover:border-3 hover:border-[#E48786] rounded-xl p-10 bg-white transition duration-300">
        <div class="flex flex-col items-center md:items-start text-center md:text-left">
          <img src="/assets/shope.png" alt="Shopee Icon">
          <h1 class="font-bold text-lg mb-1">Shopee</h1>
          <p class="text-sm text-gray-500 mb-4">
            Dapatkan produk Erdejilbab di Shopee dengan promo menarik!
          </p>
          <a href="#"
            class="text-sm text-[#946756] hover:text-black hover:bg-[#E48786] border border-gray-300 px-4 py-2 rounded shadow transition duration-200">
            Kunjungi
          </a>
        </div>
      </div>

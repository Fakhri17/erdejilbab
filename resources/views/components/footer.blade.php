<footer class="bg-primary text-white pt-14 mt-24 text-center">
  <div class="container mx-auto px-4 py-8">
    <div class="flex flex-col items-center">
      <img src="{{ asset('assets/logo-white.png') }}" alt="Erdejilbab Logo" class="h-16 mb-8">
      <p class="mb-2 text-lg font-medium max-w-5xl">
        Di Erdejilbab, kami percaya bahwa berbusana syar'i adalah bentuk ekspresi diri dan keindahan.
      ...
      <div class="flex space-x-6 my-4">
        ...
        <a href="#" class="hover:text-gray-200 transition">
          <iconify-icon icon="ic:baseline-whatsapp" width="28" height="28"></iconify-icon>
        </a>
        <a href="#" class="hover:text-gray-200 transition">
